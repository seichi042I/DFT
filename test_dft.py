...
def test_dft(
    ...
    plt.savefig(
        script_dirpath / f"test_log/dft/dft_sr{sampling_rate}_f{signal_frequency}_amp{signal_amplitude}_phs_{signal_phase}_pad{padding}_len{signal_length}.png")

    assert type(_dft[0]) == np.complex128
